---
title: "PHP Variable Variables: Standard $ vs $$"
description: "Learn about the advanced PHP phenomenon known as Variable Variables (represented by $$). Dynamically generate variable names entirely using values pulled from other strings!"
category: "php"
order: 13
---
